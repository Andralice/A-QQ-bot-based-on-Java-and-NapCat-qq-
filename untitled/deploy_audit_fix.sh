...
echo "== 1. 备份 =="
cd /opt/qq-bot
cp -p untitled-1.0-SNAPSHOT.jar untitled-1.0-SNAPSHOT.jar.bak.pre_audit_fix
ls -la untitled-1.0-SNAPSHOT.jar.bak.* | tail -4
...
echo
echo "== 5. 启动日志前 10 行 =="
head -n 10 /opt/qq-bot/qq-bot.stdout.log
